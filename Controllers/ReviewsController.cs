...
namespace FoodOrderingApp.Controllers
{
    public class ReviewsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ReviewId,UserId,RestaurantId,Rating,Comment,ReviewDate")] Review review)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ReviewId,UserId,RestaurantId,Rating,Comment,ReviewDate")] Review review)
        {
            if (ModelState.IsValid)
            {
